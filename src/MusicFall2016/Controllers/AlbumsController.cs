...
namespace MusicFall2016.Controllers
{
    ...
    public class AlbumsController : Controller
    {
        ...
        public IActionResult Delete(int? id)
        {
            ...
            ViewBag.AlbumsList = _context.Albums.Where(a => a.GenreID == album.Genre.GenreID);
            return View(album);
        ...
        public IActionResult Details(int? id)
        {
            ...
            ViewBag.AlbumsList = _context.Albums.Include(a => a.Artist).Include(a => a.Genre).Where(a => a.GenreID == album.GenreID);
            return View(album);
